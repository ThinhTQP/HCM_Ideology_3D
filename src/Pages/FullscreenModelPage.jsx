    ...
    >
      ...
      >
        ...
        {pathname === '/doublet' ? (
         ...
         {pathname === '/dang' ? (
          <>
            <HcmModel position={[0, -3, 0]} scale={3} rotation={-0.5} />
    
          </>
        ) : null}
        {pathname === '/mo-rong' ? (
          <>
            <TrongModel position={[0, -3, 0]} scale={0.5} rotation={0} />
         ...
         {pathname === '/vai-tro' ? (
          <>
                  <>
            <LeninModel position={[0, 0, -10]} rotation={1.4} scale={0.4} />
            <DangModel position={[0, 0, 10]} rotation={0} scale={0.1} />
          </>
