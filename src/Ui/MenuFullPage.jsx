...
import DangContent  from '../Data/dang.json'
import cqContent  from '../Data/cq.json'
    ...
    >
      <menu className=" flex">
        <ul className="flex flex-col items-center">
          ...
          <li>
            {pathnameUpdated !== '/vai-tro' ? <NavLink to="/vai-tro">Tính tất yếu và vai trò lãnh đạo của Đảng Cộng sản Việt Nam</NavLink> : null}
            {pathnameUpdated === '/vai-tro' ? <Navigation data={VaiTroContent} /> : null}
          </li>
          <li>
            {pathnameUpdated !== '/dang' ? (
              <NavLink to="/dang">Đảng phải trong sạch, vững mạnh</NavLink>
            ) : null}
            {pathnameUpdated === '/dang' ? <Navigation data={DangContent} /> : null}
          </li>
           <li>
            {pathnameUpdated !== '/mo-rong' ? (
              <NavLink to="/mo-rong">Sự khác biệt của Đảng Cộng sản với các đảng chính trị khác</NavLink>
            ) : null}
            {pathnameUpdated === '/mo-rong' ? <Navigation data={cqContent} /> : null}
          </li>
          {/* <li>
