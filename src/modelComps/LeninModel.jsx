...
const modelUrl = getSafeBasePathUrl('/vladimir_lenin_portrait_monument.glb')

const LeninModel = forwardRef(({ position = [0, 0, 0], rotation = 0, scale = 1,  ...props }, ref) => {
